...
func render() -> Film {
    ...
    scene.add(object: Sphere(center: Point(-1.5, 0.5, 1), radius: 1.2, material: LambertianMaterial(color: Color(1,0,0), kd: 0.7)))
    scene.add(object: Sphere(center: Point(0, 0, 1.1), radius: 1.7, material: LambertianMaterial(color: Color(0,1,0), kd: 0.7)))
    scene.add(object: Sphere(center: Point(1, -0.5, 1.2), radius: 1.9, material: LambertianMaterial(color: Color(0,0,1), kd: 0.7)))
